...
@FacesConverter(value = "mascaraValorDecimalQuatroCasasConverter")
public class MascaraValorDecimalQuatroCasasConverter implements Converter {
	...
	public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
		String valor = null;
		if ((value != null)) {
			valor = MascaraValorDecimalQuatroCasasConverter.formatarDoubleParaMascaraValorQuatroCasas((BigDecimal) value);
		}
		return valor;
	}
