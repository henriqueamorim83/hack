...
/**
 * Created by IntelliJ IDEA. User: Marcio Ballem Date: 15/02/2011 Time: 11:20:06
...
public class MailTester
{
	public static void main ( String[] args )
	{
		...
		mj.setUserMail("tonrenk@gmail.com");
		mj.setFromNameMail("Henrique");
		mj.setPassMail("garrafa87");
		...
		map.put("tonrenk@gmail.com" , "email gmail");
		map.put("henriqueamorim83@gmail.com" , "email gmail");
		// map.put("destinatario3@ig.com.br", "email ig");

		mj.setToMailsUsers(map);

		List<String> files = new ArrayList<String>();
		files.add("D:\\arquivo.txt");
